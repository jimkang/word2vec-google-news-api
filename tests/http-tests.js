...
const annoyIndexPath =
  __dirname + '/../../annoy-node/tests/data/google-news-angular.annoy';
const wordIndexDbPath =
  __dirname + '/../../annoy-node/tests/data/word-index-google-news.db';
const testPort = 9090;
